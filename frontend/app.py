...
pg = st.navigation({
    ...
    "Pipeline": [suite2p_page, calcium_page, cascade_page, dlc_page, dlc_viewer_page, tracking_quality_page, perspective_page, moseq_page, sync_page, zdrift_page, anatomy_page],
    "Explore": [explorer_page, timeline_page, gallery_page, roi_viewer_page, events_page, event_dynamics_page, correlations_page, trace_compare_page, pop_activity_page, neuropil_page, moseq_explore_page, behaviour_page, maze_anim_page],
