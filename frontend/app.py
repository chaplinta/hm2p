...
cascade_page = st.Page(str(_app_dir / "pages/cascade_page.py"), title="CASCADE", icon=":material/bolt:")
neuropil_page = st.Page(str(_app_dir / "pages/neuropil_analysis_page.py"), title="Neuropil", icon=":material/blur_on:")
...
label_review_page = st.Page(str(_app_dir / "pages/label_review_page.py"), title="Label Review", icon=":material/image_search:")
...
pop_activity_page = st.Page(str(_app_dir / "pages/population_activity_page.py"), title="Pop. Activity", icon=":material/ssid_chart:")
...
illumination_check_page = st.Page(str(_app_dir / "pages/illumination_check_page.py"), title="Illumination Check", icon=":material/light_mode:")
...
literature_page = st.Page(str(_app_dir / "pages/literature_page.py"), title="Literature", icon=":material/menu_book:")
methods_page = st.Page(str(_app_dir / "pages/methods_page.py"), title="Methods", icon=":material/functions:")
