...
pg = st.navigation({
    ...
    "Pipeline": [suite2p_page, calcium_page, cascade_page, dlc_training_page, training_qc_page, dlc_page, dlc_viewer_page, tracking_quality_page, perspective_page, moseq_page, sync_page, zdrift_page, anatomy_page],
