"""Maze Analysis — q-rose maze topology, exploration, and navigation metrics.
...
st.caption(
    "q-rose maze topology, exploration efficiency, and navigation metrics. "
    "Inspired by Rosenberg et al. (2021) eLife."
)
...
with tab_topo:
    st.subheader("Q-Rose Maze Structure")
    st.markdown(
        "The q-rose maze is a **7x5 unit grid** with internal walls creating corridors. "
