...
CHANGELOG = [
    ...
    ("2026-03-08", "12:00", "feature", "Add Maze Analysis module and page — q-rose maze topology graph (23 cells, 8 T-junctions, 6 dead ends), exploration efficiency, turn bias, path efficiency, monotonic path detection, behavioural mode segmentation, sequence entropy. Inspired by Rosenberg et al. (2021) eLife"),
