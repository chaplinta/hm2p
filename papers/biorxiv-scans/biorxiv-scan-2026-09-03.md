...
Search date: 2026-09-03. Searches covered: retrosplenial cortex (RSC/RSP), Penk/enkephalin
...
**Note on coverage:** The two constraints documented in all scans from 2026-08-21 onward
continue to apply. (1) Web search indexing lags bioRxiv submission by 3–7 days; papers posted
August 27–September 3 are unlikely to appear in search indices yet. (2) Direct fetching of
biorxiv.org remains blocked by the session proxy (egress blocked), preventing manual date
verification. Today's searches were conducted through web search indices only. No preprints
posted August 27–September 3 were identified in any search; results are consistent with the
September 2 scan.
...
No new bioRxiv preprints from August 27–September 3, 2026 were found across any of the
searched topics.
...
No new bioRxiv preprints from August 27–September 3, 2026 were found.

---

## Tangentially relevant / methods papers

No new bioRxiv preprints from August 27–September 3, 2026 were found beyond those already
logged in prior scans.

---

## Searches with no relevant results

All search topics returned no confirmed preprints from the August 27–September 3 window:

- **Retrosplenial cortex (RSC/RSP):** No new preprints. Searches surface Yang et al. PNAS
  2026 (published August 4, A-P egocentric/allocentric gradient) as the most recent RSC
  publication, alongside the June 3 distance-mapping RSC preprint (Naud et al.) and the
  February Active Pursuit paper.

- **Penk/enkephalin + cortex:** No new preprints. The monitoring period (April 2 –
  September 3, 154 days, 98 scans) has produced zero preprints characterising Penk+
  neurons in cortex in a spatial or HD context. All Penk/enkephalin hits remain
  subcortical (striatum, dorsal raphe, MPOA, enteric neurons). The gap is fully open.
...
- **Head direction + darkness / landmarks / drift:** No new experimental preprints.
  Searches continue to return the parallax-error paper (v4, March 2026), Jayakumar
  et al. (Curr Biol, 2026), and the joint visual-vestibular computation preprint
  (February 2025).
...
- **Head-mounted / miniature two-photon microscopy:** No new preprints. The Opto2P-FCM
  paper (Optica, August 2026) noted in the August 29 scan has no bioRxiv preprint.
...
- **Neuropil contamination + two-photon:** No new correction or benchmarking papers.
  Liu et al. 2026 (structural-functional calibration for volumetric calcium imaging
  identity errors, August 24) remains the most recent tangentially relevant find.

- **Spike inference / CASCADE / deconvolution:** No new preprints. Searches continue to
  return the biophysical generative model benchmark (v3, 2026) showing improved
  correlation to ground truth across varied sampling rates relative to CASCADE.
...
**New tangentially relevant / methods preprints this week:** 0

**Reason for absent coverage:** Persistent web search indexing lag (3–7 days behind
bioRxiv submission) combined with proxy block on direct biorxiv.org access. The
August 27–September 3 window cannot be confirmed as fully empty; this reflects best
available coverage from current search indices.

**Cumulative picture (April 2 – September 3, 154 days, 98 scans):**
...
## Persistent action items (carried from September 2 scan)
