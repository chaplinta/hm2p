...
Search date: 2026-08-31. Searches covered: retrosplenial cortex (RSC/RSP), Penk/enkephalin
...
**Note on coverage:** Two constraints apply this week. (1) Web search indexing of bioRxiv
continues to lag 3–7 days behind submission, consistent with the pattern documented in all
scans from 2026-08-21 onward. (2) Direct fetching of biorxiv.org is blocked by the
session proxy (egress blocked), preventing manual verification of posting dates via page
fetch. Searches are conducted through web search indices only. No preprints posted August
24–31 were identified in any search. Today's searches return the same set of papers as
the August 30 scan.
...
No new bioRxiv preprints from August 24–31, 2026 were found across any of the searched
topics.
...
No new bioRxiv preprints from August 24–31, 2026 were found.

---

## Tangentially relevant / methods papers

No new bioRxiv preprints from August 24–31, 2026 were found beyond those already logged.
The most recent tangentially relevant find (Wang et al. 2026, subthreshold GCaMP
transients) was covered in detail on 2026-08-29 and carried in the August 30 summary.

---

## Searches with no relevant results

All eleven search topics returned no confirmed preprints from the August 24–31 window:
...
- **Retrosplenial cortex (RSC/RSP):** No new preprints. Searches continue to surface
  ...
  the most recent RSC publication, alongside the June 3 distance-mapping RSC preprint
  (Naud et al.) and the February Active Pursuit paper.

- **Penk/enkephalin + cortex:** No new preprints. Monitoring period (April 2 –
  August 31, 151 days, 96 scans) has produced zero preprints characterising Penk+
...
- **Neuropil contamination + two-photon:** No new correction or benchmarking papers.
  ...
  identity errors, August 24) noted as tangentially relevant; covered in August 25 scan.
...
August 24–31 window cannot be confirmed as fully empty; this reflects best available
coverage from current search indices.

**Cumulative picture (April 2 – August 31, 151 days, 96 scans):**
...
## Persistent action items (carried from August 30 scan)
