...
Search date: 2026-09-05. Searches covered: retrosplenial cortex (RSC/RSP), Penk/enkephalin
...
No preprints posted August 29 – September 5 appeared in searches for any of the covered
topics. Direct access to biorxiv.org remains blocked by the session proxy (egress blocked);
searches rely on web search engine indexing only. The August 29 – September 5 window
cannot be confirmed as fully empty; this reflects best available coverage from current
search indices.
...
No new bioRxiv preprints from August 29 – September 5, 2026 were found across any of the
searched topics.
...
No new bioRxiv preprints from August 29 – September 5, 2026 were found.
...
All ten search topics returned no confirmed preprints from the August 29 – September 5
window:

- **Retrosplenial cortex (RSC/RSP):** No new preprints. Searches continue to surface
  Yang et al. PNAS 2026 (A-P RSC egocentric/allocentric gradient, published August 4,
  doi:10.1073/pnas.2600565123), the Goodwin/Dombeck dRSC ACh preprint (July 3), and the
  Feld/Spiers RSC graph topology preprint (July 24) as the most recent RSC literature.

- **Penk/enkephalin + cortex:** No new preprints. The full monitoring period (April 2 –
  September 5, 156 days, 100 scans) has produced zero preprints characterising Penk+
...
- **Head direction cells + two-photon imaging:** No new preprints. Searches return
  established miniaturised microscopy work from 2024–2025; nothing new this week.
...
- **Head-mounted / miniature two-photon microscopy:** No new methods preprints. The
  Opto2P-FCM instrument (Optica, August 2026) noted in prior scans has no bioRxiv preprint;
  no new additions found.
...
**Cumulative picture (April 2 – September 5, 156 days, 100 scans):**
...
- **Wang et al. 2026** (~August 25): Subthreshold membrane depolarisation generates
  substantial GCaMP soma transients (1–5% ΔF/F) in awake mice without spikes. Relevant
  to CASCADE spike-inference limits and to interpretation of dendritic ROIs in our single
  imaging plane.
...
## Persistent action items (carried from September 4 scan)
...
6. Check ROI classifier performance separating soma vs. dendrite ROIs. If separation is
   ...
   for low-firing non-Penk cells where HD tuning is weaker.
   **Priority: medium.**
