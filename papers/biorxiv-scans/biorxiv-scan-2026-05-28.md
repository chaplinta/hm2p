...
Search date: 2026-05-28. Primary window: May 27–28, 2026 (since the May 27 scan).
The broader 7-day window (May 21–28) overlaps substantially with prior scans; papers
already captured in the 2026-05-21 through 2026-05-27 scans are not repeated here.
...
No new highly relevant preprints found for May 27–28, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for May 27–28, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for May 27–28, 2026.

---

## Searches with no new results (May 27–28)

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified in the May 27–28
window on spatial coding, HD tuning, visual processing, or cell-type-specific function.
The most recent substantive RSC preprint in the monitoring window remains Oh et al. 2026
(May 10, RSC PV/SST interneuron spatial coding dissociation; first captured in the
2026-05-14 scan).

**Penk/enkephalin + cortex:** No new preprints. This is the thirty-second consecutive scan
cycle without a cortical Penk+ navigational or spatial paper. All Penk hits across the
full monitoring period have been subcortical (striatum, hypothalamus, brainstem, dorsal
raphe). The absence of any literature characterising Penk+ RSP neurons in a spatial or
...
The May 27–28 window is quiet across all monitored topic areas. This continues the
pattern of zero relevant new preprints since the May 14–18 cluster.

**Cumulative picture (April 2–May 28, 57 days, 32 scans):**
...
**Persistent action items (unchanged from May 27 scan):**
