# bioRxiv Scan — 11 September 2026
...
Search date: 2026-09-11. Searches covered: retrosplenial cortex (RSP/RSC),
...
submission by 3–7 days, so preprints posted September 8–11 are unlikely to appear yet.
Papers from September 3–10 already covered in prior daily scans are not re-reported here.

---

## Highly relevant papers

*No new preprints from the September 4–11 window were identified as highly relevant to
...
*No new preprints meeting this threshold were identified in the September 10–11 window.
Van Beest et al. 2026 ("Brainwide representation of navigation,"
https://www.biorxiv.org/content/10.64898/2026.08.29.747979v1) remains the only paper
from the last 7 days meeting the moderately relevant bar; it was reported in full in the
2026-09-07 scan and carried forward in subsequent daily scans. Not duplicated here.*
...
CASCADE, or miniature two-photon microscopy were identified in the September 10–11
window.*

---

## Searches with no new results (September 10–11)

All searches returned the same set as the September 10 scan.

**Retrosplenial cortex (RSP/RSC):** No new preprints.

**Penk/enkephalin + cortex:** No new preprints. Now 163 days (101 scans) of monitoring
with zero preprints characterising Penk+ neurons in cortex in a spatial or HD context.
The gap persists.

**Head direction cells + two-photon imaging:** No new preprints.

**Head direction + darkness / landmarks / drift:** No new preprints.

**Spatial navigation + maze (rodents) + calcium imaging:** No new preprints.
...
**Papers from the last 7 days (September 4–11):** 0 new papers identified beyond van
Beest et al. (Sep 3, covered in 2026-09-07 scan).
...
appeared in 163 days of monitoring (101 daily scans since 2026-04-02). The hm2p
question remains unaddressed in the preprint literature.

**Publication notes (carry-forward from Sep 10):**

- Jayakumar et al. postsubiculum HD / parallax paper → published (PMC:13001495).
  Update journal citation in manuscript reference list.
- Secer et al. area 29e landmark coupling paper → published (PMC:12642567).
  Update journal citation in manuscript reference list.
- M-MINI2P (March 2025 bioRxiv) → published in Cell Reports Methods.
- miniBB2p (October 2024 bioRxiv) → published in Nature Communications.

---

## Persistent action items (carried from September 10 scan)
...
3. Include running speed as a covariate in all HD tuning models; do not compare HD
   ...
   Cite van Beest et al. 2026 (brainwide navigation paper). **Priority: high.**
