...
Search date: 2026-07-14. Primary window: July 14, 2026 (since the July 13 scan).
The broader 7-day window (July 7–14) overlaps substantially with prior scans; papers
already captured in the 2026-04-02 through 2026-07-13 scans are not repeated here.
...
Papers listed in any prior scan (2026-04-02 through 2026-07-13) are not repeated here.
...
No new highly relevant preprints found for July 14, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for July 14, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for July 14, 2026.

---

## Searches with no new results (July 14)

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified on spatial
coding, HD tuning, visual processing, or cell-type-specific function. Search-engine
coverage of papers posted today (July 14) is expected to be incomplete given typical
indexing lag of days to weeks.

**Penk/enkephalin + cortex:** No new preprints. Sixty-second consecutive scan cycle
...
enteric nervous system). The literature gap for Penk+ RSP neurons in a spatial/HD
context is intact.
...
The July 14 window is quiet across all monitored topic areas. Tuesday posting volume on
bioRxiv is typically moderate but search-engine indexing lag means papers posted today
are unlikely to surface in web searches for several days.

**Cumulative picture (April 2–July 14, 103 days, 62 scans):**
...
- **Goodwin, Dombeck et al. 2026** (July 3): ACh release in dRSC coordinates
  ...
  tuning dynamics at light-off transitions — predicts a transient tuning-degradation
  peak in the first 30 s of each dark epoch. Captured in the 2026-07-10 scan.
...
- **Oh et al. 2026** (May 10): RSC PV/SST interneurons and egocentric spatial coding
  ...
  boundary-anchored activity. Informs Discussion framing of Penk+ vs Penk⁻CamKII+ HD
  differences: excitatory cell-type differences are likely shaped by differential
  PV/SST gate state.
...
- **Prankerd et al. 2026** (May 15): coppaFISH 3D volumetric in situ sequencing +
  ...
  to in vivo 2P-imaged neurons. Relevant as a future validation tool for confirming
  viral cell-type labels in our dataset.
  https://www.biorxiv.org/content/10.64898/2026.05.15.725413v1

**Persistent action items (unchanged from July 13 scan):**
