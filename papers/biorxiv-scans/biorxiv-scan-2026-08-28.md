...
Search date: 2026-08-28. Searches covered: retrosplenial cortex (RSC/RSP), Penk/enkephalin
...
submission. No preprints posted August 21–28 appeared in searches for any of the covered
topics, consistent with the indexing-lag pattern documented in all scans from 2026-08-21
onward. Direct access to biorxiv.org is blocked in this execution environment; searches
rely on web search engine indexing only. The August 21–28 window cannot be confirmed as
fully empty; this reflects best available coverage from current search indices.

---

## Highly relevant papers

No new bioRxiv preprints from August 21–28, 2026 were found across any of the searched
topics.
...
No new bioRxiv preprints from August 21–28, 2026 were found.
...
All ten search topics returned no confirmed preprints from the August 21–28 window:

- **Retrosplenial cortex (RSC/RSP):** No new preprints. Searches surface the same
  papers noted in recent scans — Yang et al. PNAS 2026 (A-P RSC egocentric/allocentric
  gradient, published August 4, doi:10.1073/pnas.2600565123), Goodwin/Dombeck dRSC ACh
  preprint (July 3), and Feld/Spiers RSC graph topology preprint (July 24).

- **Penk/enkephalin + cortex:** No new preprints. The full monitoring period (April 2 –
  August 28, 148 days) has produced zero preprints characterising Penk+ neurons in cortex
  in a spatial or HD context. All Penk/enkephalin hits remain subcortical (striatum, dorsal
  raphe, MPOA, enteric neurons). The gap remains fully open.

- **Head direction cells + two-photon imaging:** No new preprints. Searches continue to
  return miniaturised microscopy work from 2024–2025; nothing new this week.
...
- **Head-mounted / miniature two-photon microscopy:** No new methods preprints this week.
...
**Cumulative picture (April 2 – August 28, 148 days):**
...
## Persistent action items (carried from August 27 scan)
...
6. Note coordinated representational drift result (Peters et al. 2026) when reporting
   session-wise HD tuning stability — within-session estimates are more reliable than
   cross-session comparisons.
   **Priority: low.**

7. Watch for RSP follow-up from the Giocomo lab structured navigation platform
