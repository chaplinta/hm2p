...
Search date: 2026-07-13. Primary window: July 12–13, 2026 (since the July 12 scan).
The broader 7-day window (July 6–13) overlaps substantially with prior scans; papers
already captured in the 2026-04-02 through 2026-07-12 scans are not repeated here.
...
Papers listed in any prior scan (2026-04-02 through 2026-07-12) are not repeated here.
...
No new highly relevant preprints found for July 12–13, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for July 12–13, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for July 12–13, 2026.

---

## Searches with no new results (July 12–13)

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified on spatial
coding, HD tuning, visual processing, or cell-type-specific function. Web-indexed
DOI-pattern searches for July 2026 biorxiv submissions (10.64898/2026.07.11–13)
returned no results matching these topics.

**Penk/enkephalin + cortex:** No new preprints. This is the sixty-first consecutive
...
The July 12–13 window is quiet across all monitored topic areas. The field is in a
weekend/early-week trough: bioRxiv posting volume is typically lowest on Sundays and
Mondays, and search-engine indexing lag means very recently posted papers may not yet
appear in web searches.

**Cumulative picture (April 2–July 13, 102 days, 61 scans):**
...
**Persistent action items (unchanged from July 12 scan):**
