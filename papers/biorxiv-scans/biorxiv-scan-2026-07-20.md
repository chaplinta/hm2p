...
Search date: 2026-07-20. Primary window: July 18–20, 2026 (since the July 18 scan).
The broader 7-day window (July 13–20) overlaps substantially with prior daily scans;
...
papers are indexed with a lag of days to weeks and may not be captured.

---

## Highly relevant papers

No new highly relevant preprints found for July 18–20, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for July 18–20, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for July 18–20, 2026.

---

## Searches with no new results (July 18–20)

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified for July 18–20.
Indexing lag for papers posted in the past 48–72 hours is expected to be several days.
The most recent RSC preprint surfacing in searches remains the Goodwin/Dombeck et al.
ACh paper (July 3, 2026; captured in the 2026-07-10 scan).

**Penk/enkephalin + cortex:** No new preprints. This is the sixty-seventh consecutive
...
Quiet window across all monitored topics. Searches for the broader 7-day window
(July 13–20) returned the same papers already captured in the July 10–18 daily scans.
Search-engine indexing lag means papers posted July 18–20 are unlikely to surface in
web searches for several more days.

**Cumulative picture (April 2–July 20, 109 days, 67 scans):**
