...
Search date: 2026-05-26. Primary window: May 25–26, 2026 (since the May 25 scan).
The broader 7-day window (May 19–26) overlaps substantially with prior scans; papers
already captured in the 2026-05-19 through 2026-05-25 scans are not repeated here.
...
No new highly relevant preprints found for May 25–26, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for May 25–26, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for May 25–26, 2026.

---

## Searches with no new results (May 25–26)

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified in the May
25–26 window. The most recent substantive RSC preprint in the monitoring window remains
Oh et al. 2026 (May 10, RSC PV/SST interneuron spatial coding dissociation; first
captured in the 2026-05-14 scan).

**Penk/enkephalin + cortex:** No new preprints. This is the thirtieth consecutive scan
cycle without a cortical Penk+ navigational or spatial paper. The April 2026 MPOA Penk
paper (sustained mating behavior; https://www.biorxiv.org/content/10.64898/2026.04.03.716295v1)
remains the only 2026 cortical-adjacent Penk hit, and it is not relevant to RSP HD
function. The absence of any literature characterising Penk+ RSP neurons in a spatial or
HD context remains complete.
...
The May 25–26 window is quiet across all monitored topic areas. This continues the
pattern of zero relevant new preprints since the May 14–18 cluster.

**Cumulative picture (April 2–May 26, 55 days, 30 scans):**
...
**Persistent action items (unchanged from May 25 scan):**
