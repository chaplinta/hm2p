...
Search date: 2026-08-24. Searches covered: retrosplenial cortex (RSC/RSP), Penk/enkephalin
...
submission. No preprints posted August 17–24 appeared in any search on these topics, consistent
with the pattern documented in all scans from 2026-08-21 onward.

---

## Highly relevant papers

No new bioRxiv preprints from August 17–24, 2026 were found across any of the searched
topics.
...
No new bioRxiv preprints from August 17–24, 2026 were found.
...
All ten search topics returned no confirmed preprints from the August 17–24 window:

- **Retrosplenial cortex (RSC/RSP):** No new preprints. Searches continue to surface the
  same recent papers noted in the 2026-08-23 scan — Yang et al. PNAS 2026 (A-P RSC
  egocentric/allocentric gradient, published August 4) and the July 27 structured-navigation
  preprint from the Giocomo lab.

- **Penk/enkephalin + cortex:** No new preprints. The full monitoring period (April 2 –
  August 24, 144 days, 93 scans) has produced zero preprints characterising Penk+ neurons
...
- **Head direction cells + two-photon imaging:** No new preprints. Searches continue to
  return MINI2P and miniaturised microscopy work from 2024–2025; nothing new this week.

- **Head direction + darkness / landmarks / drift:** No new experimental preprints. Results
  stable since the parallax error paper (v4, March 2026) and Jayakumar et al. (Curr Biol,
  2026).
...
bioRxiv submission). The August 17–24 window cannot be confirmed as fully empty; this
reflects best available coverage from current search indices.

**Cumulative picture (April 2 – August 24, 144 days, 93 scans):**
...
## Persistent action items (carried from August 23 scan)
