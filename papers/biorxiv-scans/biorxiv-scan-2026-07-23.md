...
Search date: 2026-07-23. Primary window: July 23, 2026 (since the July 22 scan).
The broader 7-day window (July 16–23) overlaps substantially with prior daily scans;
...
No new highly relevant preprints found for July 23, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for July 23, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for July 23, 2026.

---

## Searches with no new results

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified. Searches
continue to surface papers from earlier in 2026 already captured in prior scans. Papers
posted on or after July 21 have not yet been indexed by search engines.

**Penk/enkephalin + cortex:** No new preprints. Sixty-eighth consecutive scan cycle
without a cortical Penk+ spatial or navigational paper. All Penk hits across the full
monitoring period remain subcortical (striatum, dorsal raphe, enteric nervous system,
hypothalamus, brainstem). Gap in the literature remains open — this is a clear
contribution of the hm2p project.
...
Searches surfaced only previously captured work (Tian et al. MEC + light deprivation;
Jayakumar et al. locomotion-dependent recalibration).
...
Quiet window. Search-engine indexing lag means papers posted July 21–23 are unlikely
to surface in web searches for several more days.

**Cumulative picture (April 2–July 23, 112 days, 68 scans):**
...
preprints within the active monitoring period, ranked by recency:
...
- **Goodwin, Dombeck et al. 2026** (July 3): ACh release in dRSC coordinates
  ...
  tuning dynamics at light-off transitions.
...
- **Coordinated representational drift across mouse cortex** (May 5): RSC confirmed as
  highest-density spatially tuned region in dorsal cortex; within-session stability
