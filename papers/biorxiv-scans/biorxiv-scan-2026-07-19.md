...
Search date: 2026-07-19. Primary window: July 18–19, 2026 (since the July 18 scan).
The broader 7-day window (July 12–19) overlaps substantially with prior daily scans;
papers already captured in the 2026-04-02 through 2026-07-18 scans are not repeated here.
...
calcium imaging + cell-type identification, cognitive map updating + cortex.

Papers listed in any prior scan (2026-04-02 through 2026-07-18) are not repeated here.
...
No new highly relevant preprints found for July 18–19, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for July 18–19, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for July 18–19, 2026.

---

## Searches with no new results (July 18–19)

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified for July 18–19.
Search-engine indexing lag for papers posted in the past 24–48 hours is expected to be
several days. The July 2026 DOI range searched (10.64898/2026.07.1x) returned only
papers already captured in prior scans or outside scope (oncology, cell biology).

**Penk/enkephalin + cortex:** No new preprints. This is the sixty-sixth consecutive
...
**Head direction + two-photon imaging (freely moving):** No new preprints. Repeated
searches across this topic yielded no papers posted after July 18, 2026.

**Head direction + darkness / visual landmarks / drift:** No new experimental papers.
The most recent paper on this topic in the monitoring window remains Reshef et al. 2026
(NMDA-dependent place field refinement; July 16 scan).

**Spatial navigation + maze + calcium imaging (freely moving mouse):** No new papers
matching all criteria. Broader searches returned older papers and unrelated work (rat
ephys, virtual reality head-fixed).
...
**Cognitive map updating + cortex:** The hippocampal-midcingulate connectivity paper
(Nakahara group; doi:10.64898/2026.07.16.738868) surfaced in broad searches as a July
16 paper on representational integration during cognitive map updating. Not directly
relevant to RSP HD cells; concerns prefrontal/cingulate cognitive map updating in
humans during fMRI, not rodent calcium imaging. Not included as a stand-alone entry.
...
papers posted July 18–19 are unlikely to surface in web searches for several more days.

**Cumulative picture (April 2–July 19, 108 days, 66 scans):**
...
- **Goodwin, Dombeck et al. 2026** (July 3): ACh release in dRSC coordinates
  ...
  tuning dynamics at light-off transitions. Captured in the 2026-07-10 scan.
...
**Persistent action items (unchanged from July 18 scan):**
