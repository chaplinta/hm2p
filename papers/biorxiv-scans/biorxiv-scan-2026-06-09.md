...
Search date: 2026-06-09. Primary window: June 9, 2026 (since the June 8 scan covered
June 7–8). The broader 7-day window (June 2–9) overlaps substantially with prior scans;
papers already captured in the 2026-04-02 through 2026-06-08 scans are not repeated here.
...
indexed with a lag of days to weeks may not be captured.

Note on C-SPIKES (Broussard et al., doi:10.1101/2024.12.31.630967v3): search engines
attributed a June 4, 2026 date to this paper, but this corresponds to the PubMed/PMC
deposit date following journal acceptance, not a new bioRxiv post. The preprint was
originally submitted to bioRxiv on 2024-12-31 and was not flagged in the June 3–6
scan window. It is therefore not counted as a new result for this week.

---

## Highly relevant papers

No new highly relevant preprints found for June 9, 2026.

---

## Moderately relevant papers

No new moderately relevant preprints found for June 9, 2026.

---

## Tangentially relevant / methods papers

No new tangentially relevant or methods papers found for June 9, 2026.

---

## Searches with no new results (June 9)

**Retrosplenial cortex (RSP/RSC):** No new RSC/RSP preprints identified on spatial
coding, HD tuning, visual processing, or cell-type-specific function. The most recent
substantive RSC preprint in the monitoring window remains Oh et al. 2026 (May 10, RSC
PV/SST interneuron spatial coding dissociation; first captured in the 2026-05-14 scan).

**Penk/enkephalin + cortex:** No new preprints. This is the thirty-sixth consecutive
scan cycle without a cortical Penk+ navigational or spatial paper. All Penk hits across
the full monitoring period have been subcortical (striatum, hypothalamus, brainstem,
dorsal raphe). The absence of any literature characterising Penk+ RSP neurons in a
spatial or HD context remains complete.
...
The June 9 window is quiet across all monitored topic areas. This continues the pattern
of zero relevant new preprints since the May 14–18 cluster.

**Cumulative picture (April 2–June 9, 68 days, 36 scans):**
...
substantive preprints within the active monitoring window remain unchanged from the
June 8 scan:
...
**Persistent action items (unchanged from June 8 scan):**
