...
Search date: 2026-09-01. Searches covered: retrosplenial cortex (RSC/RSP), Penk/enkephalin
...
**Note on coverage:** The same two constraints that have applied since 2026-08-21 continue
today. (1) Web search indexing lags bioRxiv submission by 3–7 days; papers posted
August 26–September 1 are unlikely to appear in search indices yet. (2) Direct fetching
of biorxiv.org remains blocked by the session proxy (egress blocked), preventing manual
date verification. Today's searches are conducted through web search indices only and
return the same paper set as the August 30–31 scans.

---

## Highly relevant papers

No new bioRxiv preprints from August 25–September 1, 2026 were found across any of
the searched topics. This is consistent with the continuing indexing lag documented
in scans from 2026-08-21 onward.

---

## Moderately relevant papers

No new bioRxiv preprints from August 25–September 1, 2026 were found.
...
All search topics returned no confirmed preprints from the August 25–September 1 window:
...
- **Penk/enkephalin + cortex:** No new preprints. The monitoring period now spans April
  2–September 1, 2026 (153 days, 97 scans) with zero preprints characterising Penk+
...
- **Neuropil contamination + two-photon:** No new correction or benchmarking papers.
  ...
  identity errors, August 24) covered in the August 25 scan remains the most recent find.
...
August 25–September 1 window cannot be confirmed as fully empty; this reflects best
available coverage from current search indices.

**Cumulative picture (April 2 – September 1, 153 days, 97 scans):**

No preprint has characterised HD tuning of genetically-defined RSP excitatory neuron
populations (Penk+ or Penk⁻CamKII+). The gap remains fully open.
...
## Persistent action items (carried from August 31 scan)
