...
class TestBuildCanvasPayload:
    ...
    def test_returns_dict(self):
        ...
        payload = _build_canvas_payload(
            x, y, hd, speed, light_on, ft, trail_seconds=2.0, step=5, arrow_length=0.5
        )
    ...
    def test_payload_has_required_keys(self):
        ...
        payload = _build_canvas_payload(
            x, y, hd, speed, light_on, ft, trail_seconds=1.0, step=1, arrow_length=0.5
        )
        required_keys = {
            "n_frames",
            "bp_names",
    ...
    def test_subsample_reduces_frames(self):
        ...
        p1 = _build_canvas_payload(
            x, y, hd, speed, light_on, ft, trail_seconds=1.0, step=1, arrow_length=0.5
        )
        p5 = _build_canvas_payload(
            x, y, hd, speed, light_on, ft, trail_seconds=1.0, step=5, arrow_length=0.5
        )
    ...
    def test_light_on_encoded_as_int(self):
        ...
        x, y, hd, speed, light_on, ft = self._make_test_data(50)
        payload = _build_canvas_payload(
            x, y, hd, speed, light_on, ft, trail_seconds=1.0, step=2, arrow_length=0.5
        )
    ...
    def test_arrow_length_preserved(self):
        ...
        payload = _build_canvas_payload(
            x, y, hd, speed, light_on, ft, trail_seconds=1.0, step=1, arrow_length=0.75
        )
    ...
    def test_trail_seconds_preserved(self):
        ...
        x, y, hd, speed, light_on, ft = self._make_test_data(20)
        payload = _build_canvas_payload(
            x, y, hd, speed, light_on, ft, trail_seconds=5.0, step=1, arrow_length=0.5
        )
